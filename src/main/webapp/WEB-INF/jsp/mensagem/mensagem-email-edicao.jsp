            ...
            <div class="my-3 p-3 bg-white rounded shadow-sm">
              ...
              <form method="post" action="">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="destinatario" class="form-control rounded" value="${mensagem.destinatario}"></input>
                </div>
                
                 <div class="form-group">
                  <label>Em Cópia:</label>
                  <input type="text" name="emCopia" class="form-control rounded" value="${mensagem.emCopia}"></input>
                 </div>
                 
                 <div class="form-group">
                   <label>Em Cópia Oculta:</label>
                   <input type="text" name="emCopiaOculta" class="form-control rounded" value="${mensagem.emCopiaOculta}"></input>
                 </div>
                 
                 <div class="form-group">
                  <label>Mensagem:</label>
                  <textarea name="mensagem" class="form-control rounded" rows="2">${mensagem.mensagem}</textarea>
                </div>
