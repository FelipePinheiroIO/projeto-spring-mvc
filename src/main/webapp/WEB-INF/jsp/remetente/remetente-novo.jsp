          ...
          <div class="container projeto-pt-80">
            ...
            <div class="my-3 p-3 bg-white rounded shadow-sm">
              <div class="align-items-center p-3 my-3 projeto-bg-green text-white font-weight-bold rounded shadow-sm">  
                NOVO REMETENTE DA MENSAGEM:
              </div>


              <form method="post" action="/agendamentos/${idAgendamento}/remetente-novo">
             
                <div class="form-group">
                  <label>Nome:</label>
                  <input type="text" name="nome" class="form-control rounded"></input>
                </div>
                
                 <div class="form-group">
                  <label>E-mail:</label>
                  <input type="text" name="email" class="form-control rounded"></input>
                 </div>
                 
                 <div class="form-group">
                   <label>Celular:</label>
                   <input type="text" name="celular" class="form-control rounded"></input>
                 </div>
