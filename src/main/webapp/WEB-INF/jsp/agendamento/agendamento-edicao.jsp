            ...
            <div class="my-3 p-3 bg-white rounded shadow-sm">
              ...
              <form method="post" action="">
                ...
                <div class="form-group">
                  ...
                  <textarea name="descricao" class="form-control rounded" rows="2">${agendamento.descricao}</textarea>
                </div>
                
                 <div class="form-group">
                 <label>Prioridade:</label>
                  <select class="form-control rounded" name="prioridade" value="${agendamento.prioridade}">
			        <option class="rounded" value="alta" selected>Alta</option>
			        <option class="rounded" value="media">Média</option>
			        <option class="rounded" value="baixa">Baixa</option>
			      </select>
                </div>

                <div class="form-group">
                  <label>Dia/Hora do envio:</label>
                  <input type="datetime-local" name="dataHoraEnvio" class="form-control rounded" value="${agendamento.dataHoraEnvio}"></input>
                </div>
